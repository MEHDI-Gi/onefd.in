function ChapteOne() {
    const ExNum1 = () => {
        let vidNum1 = document.getElementById('vid-num-1');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum2 = () => {
        let vidNum2 = document.getElementById('vid-num-2');
        vidNum2.style.height = vidNum2.style.height === '156px' ? '' : '156px';
    };
    const ExNum3 = () => {
        let vidNum3 = document.getElementById('vid-num-3');
        vidNum3.style.height = vidNum3.style.height === '156px' ? '' : '156px';
    };
    const ExNum4 = () => {
        let vidNum4 = document.getElementById('vid-num-4');
        vidNum4.style.height = vidNum4.style.height === '156px' ? '' : '156px';
    };
    const ExNum5 = () => {
        let vidNum5 = document.getElementById('vid-num-5');
        vidNum5.style.height = vidNum5.style.height === '156px' ? '' : '156px';
    };
    const ExNum6 = () => {
        let vidNum6n = document.getElementById('vid-num-6');
        vidNum6n.style.height = vidNum6n.style.height === '156px' ? '' : '156px';
    };
    const ExNum7 = () => {
        let vidNum1 = document.getElementById('vid-num-7');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum8 = () => {
        let vidNum1 = document.getElementById('vid-num-8');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum9 = () => {
        let vidNum1 = document.getElementById('vid-num-9');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum10 = () => {
        let vidNum1 = document.getElementById('vid-num-10');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum11 = () => {
        let vidNum1 = document.getElementById('vid-num-11');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum12 = () => {
        let vidNum1 = document.getElementById('vid-num-12');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum13 = () => {
        let vidNum1 = document.getElementById('vid-num-13');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum14 = () => {
        let vidNum1 = document.getElementById('vid-num-14');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum15 = () => {
        let vidNum1 = document.getElementById('vid-num-15');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum16 = () => {
        let vidNum1 = document.getElementById('vid-num-16');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum17 = () => {
        let vidNum1 = document.getElementById('vid-num-17');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum18 = () => {
        let vidNum1 = document.getElementById('vid-num-18');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum19 = () => {
        let vidNum1 = document.getElementById('vid-num-19');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    const ExNum20 = () => {
        let vidNum1 = document.getElementById('vid-num-20');
        vidNum1.style.height = vidNum1.style.height === '156px' ? '' : '156px';
    };
    ...
    return(
        <div>
            <div className="lists" >
            <div className="list" id="lessons">
            <div className="list-title"><h3>دروس</h3></div>
            <div className="list-title"><h3>دروس</h3></div>
            ...
            <div className="lists">
                ...
                <div className="list-title"><h3>تمارين</h3></div>
                <div id="exercise">
                    <div>
                        <ul>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2206"><h3>التمرين 01</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2329"><h3>التمرين 02</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2410"><h3>التمرين 03</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2532"><h3>التمرين 04</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2752"><h3>التمرين 05</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2873"><h3>التمرين 06</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=3616"><h3>التمرين 07</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=3691"><h3>التمرين 08</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=3796"><h3>التمرين 09</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=4352"><h3>التمرين 10</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=4578"><h3>التمرين 11</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5054"><h3>التمرين 12</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5249"><h3>التمرين 13</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5450"><h3>التمرين 14</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5612"><h3>التمرين 15</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5705"><h3>التمرين 16</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5826"><h3>التمرين 17</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5913"><h3>التمرين 18</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5987"><h3>التمرين 19</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=6080"><h3>التمرين 20</h3></a></li>

                        </ul>
                    </div>
                    <div>
                        <ul>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2274"><h3>تصحيح التمرين 01</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2274"><h3>تصحيح التمرين 02</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2463"><h3>تصحيح التمرين 03</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2573"><h3>تصحيح التمرين 04</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2792"><h3>تصحيح التمرين 05</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=2910"><h3>تصحيح التمرين 06</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=3653"><h3>تصحيح التمرين 07</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=3729"><h3>تصحيح التمرين 08</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=3888"><h3>تصحيح التمرين 09</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=4468"><h3>تصحيح التمرين 10</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=4627"><h3>تصحيح التمرين 11</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5166"><h3>تصحيح التمرين 12</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5288"><h3>تصحيح التمرين 13</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5562"><h3>تصحيح التمرين 14</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5660"><h3>تصحيح التمرين 15</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5742"><h3>تصحيح التمرين 16</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5864"><h3>تصحيح التمرين 17</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=5951"><h3>تصحيح التمرين 18</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=6035"><h3>تصحيح التمرين 19</h3></a></li>
                            <li><a href="http://scolarium-moyen.onefd.edu.dz/mod/resource/view.php?id=6120"><h3>تصحيح التمرين 20</h3></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className='lists'>
                <div className="list">
                    <div className="list-title"><h3>كتب</h3></div>
